      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.metricsContainer}>
          ...
          <Card style={styles.metricCard}>
            ...
            <Text style={styles.metricValue}>${salesAnalytics.totalRevenue.toLocaleString()}</Text>
                ...
                <View key={index} style={styles.chartBar}>
                  <View style={styles.barContainer}>
                    <View 
                      style={[
                        styles.bar, 
                        { height: barHeight || 4, backgroundColor: month.revenue > 0 ? '#2563eb' : '#e2e8f0' }
                      ]} 
                    />
                  </View>
                  <Text style={styles.barLabel}>{month.month}</Text>
                  <Text style={styles.barValue}>${month.revenue.toFixed(0)}</Text>
                </View>
              );
            })}
          </View>
        ...
        <Card style={styles.performanceCard}>
          <Text style={styles.chartTitle}>Sales Performance (Last 30 Days)</Text>
          <View style={styles.performanceStats}>
            <View style={styles.performanceStat}>
              <Text style={styles.performanceValue}>{salesAnalytics.totalQuantitySold}</Text>
              <Text style={styles.performanceLabel}>Items Sold</Text>
            </View>
            <View style={styles.performanceStat}>
              <Text style={styles.performanceValue}>${salesAnalytics.averageOrderValue.toFixed(2)}</Text>
              <Text style={styles.performanceLabel}>Avg Order Value</Text>
            </View>
            <View style={styles.performanceStat}>
              <Text style={styles.performanceValue}>
                {salesAnalytics.totalSales > 0 ? (salesAnalytics.totalRevenue / salesAnalytics.totalSales).toFixed(2) : '0.00'}
              </Text>
              <Text style={styles.performanceLabel}>Revenue per Sale</Text>
            </View>
          </View>
        </Card>
      </ScrollView>
